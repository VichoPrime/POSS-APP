...
interface Product {
  ...
  rotacion_minima?: number; // Rotación mínima en los últimos 30 días
  is_low_rotation?: boolean; // Indicador de baja rotación
}
    ...
    <PermissionGuard permission="can_manage_products">
      ...
      <div className="row">
        <div className="col-12">
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label className="form-label">Rotación Mínima (30 días)</label>
                        <input
                          type="number"
                          className="form-control"
                          value={formData.rotacion_minima || ''}
                          onChange={(e) => setFormData({...formData, rotacion_minima: e.target.value ? parseInt(e.target.value) : undefined})}
                          placeholder="Opcional"
                        />
                        <small className="text-muted">
                          {formData.unit_type === 'peso' ? 'Ventas mínimas en kg' : 'Ventas mínimas en unidades'} en un período de 30 días
                        </small>
                      </div>
                    </div>
                  </div>
          ...
          <div className="card">
            <div className="card-header">
              <h5>Productos Registrados ({products.length})</h5>
            </div>
            <div className="card-body">
                    ...
                    {products.map(product => (
                      <tr key={product.id}>
                        ...
                        <td>
                          <div>
                            ...
                            {product.stock_minimo && (
                              <>
                                <br />
                                <small className="text-muted">Stock Mín: {product.stock_minimo}</small>
                              </>
                            )}
                            {product.rotacion_minima && (
                              <>
                                <br />
                                <small className="text-muted">Rotación Mín: {product.rotacion_minima}/30d</small>
                              </>
                            )}
                          </div>
                        </td>
                        ...
                        <td>
                          ...
                          {product.is_low_rotation ? (
                            <span className="badge bg-warning text-dark me-1" title={`Ventas en los últimos 30 días por debajo del mínimo (${product.rotacion_minima})`}>
                              Baja Rotación
                            </span>
                          ) : null}
